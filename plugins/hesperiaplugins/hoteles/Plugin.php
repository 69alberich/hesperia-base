...
use Carbon\Carbon;
use Event;
use HesperiaPlugins\Hoteles\Classes\Event\BackendUserModelExtension;
use HesperiaPlugins\Hoteles\Classes\Event\BackendUserControllerExtension;
...
class Plugin extends PluginBase
{
    ...
    protected function addEventListener(){
        ...
        Event::subscribe(BackendUserModelExtension::class);
        Event::subscribe(BackendUserControllerExtension::class);
