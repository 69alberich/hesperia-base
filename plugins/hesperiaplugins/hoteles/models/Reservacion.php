      ...
      foreach ($detalles as $detalle) {
        ...
        foreach ($detalle->upgrades as $upgrade_hab) {
          ...
          $upsellings_hab[$j]=[
            ...
            "precio" => number_format($upgrade_hab->precio, 0 ,",", "." )." ".$this->moneda->acronimo,
    ...
    public function aprobar($pago_insite = null){
      ...
      try {
        ...
        Mail::send("hesperiaplugins.hoteles::mail.aprobacion_reserva",
          $resumen, function($message) use ($reservacion, $resumen) {
          ...
          $emails = $reservacion->hotel->emails_notificacion;
