$(document).ready(function(){
  ...
  stripe = Stripe('pk_live_51OEdnqCb0r4HY33PDwyrq5s5nvLf9uK7SVzURyZjCOhim1MIuy8RolMGZoXybWJxkXraUZD8rPjaY8eimOQx7Yco00TgsgIlUR');
  
//ṕrod  pk_live_DZup3QCUEaUBl1nYzOQz09ax
//test pk_test_zf57RZ3Om1f1jFNtrOyN2Ixb
  ...
  var dfd = jQuery.Deferred();
    stripe.createToken(card).then(function(result) {
      ...
      if (result.error) {
        ...
        $("#payment-form").find("button").attr("disabled","disabled").text("Espere..").append("<i class='fa fa-spinner fa-spin fa-fw'></i>");
